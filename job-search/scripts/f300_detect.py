...
from f300_companies import F300 as F200
from f200_companies import SLUGS, WD_HOSTS
...
print(f"discovering endpoints for {len(F200)} companies (ranks 201-300)...", file=sys.stderr)
res = []
...
json.dump(res, open("f300_endpoints.json","w"), indent=1)
